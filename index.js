    ...
    if (req.method === "GET") {
        ...
        switch (req.url) {
            case '/Create-Account.html':
                ...
                //console.log(req);
                fs.createReadStream("./html/Create-Account.html", "UTF-8").pipe(res);
                console.log("---------------");
                break;
            case '/User-Profile-View.html':
                console.log("Attempting to load '/User-Profile-View.html' | URL=" + req.url);
                //console.log(req);
                fs.createReadStream("./html/User-Profile-view.html", "UTF-8").pipe(res);
                console.log("---------------");
                break;
            case '/Sign-In.html':
                console.log("Attempting to load '/Sign-In.html' | URL=" + req.url);
                //console.log(req);
                fs.createReadStream("./html/Sign-In.html", "UTF-8").pipe(res);
                console.log("---------------");
                break;
            case '/index.html':
            ...
            case '/resources/demos/style.css':
                ...
                //console.log(req);
                fs.createReadStream("./css/style.css", "UTF-8").pipe(res);
                console.log("---------------");
                break;
            case '/css/CSS-Reset.css':
                console.log("Attempting to load '/css/CSS-Reset.css' | URL=" + req.url);
                //console.log(req);
                fs.createReadStream("./css/CSS-Reset.css", "UTF-8").pipe(res);
                console.log("---------------");
                break;
            case '/favicon.ico':
                console.log("Attempting to load '/favicon.ico' | URL=" + req.url);
                //console.log(req);
                fs.createReadStream("./favicon.ico", "UTF-8").pipe(res);
                console.log("---------------");
                break;
            default:
